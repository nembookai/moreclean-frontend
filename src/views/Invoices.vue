<template>
  <div>
    ...
    <div class="flex gap-x-2 items-center" v-if="!loading.loading">
    ...
    <div class="flex flex-col gap-y-3 mt-3" v-if="customers?.length">
      ...
      <div class="box grid grid-cols-12 gap-x-10 !p-2.5 !pr-4" v-for="customer in customers" :key="customer.id">
        <div class="col-span-3">
          <div class="relative group">
            <div class="bg-gray-50 border border-gray-200 relative text-gray-800 text-[13px] font-light rounded-md p-2">
        ...
        <div class="col-span-9">
          ...
          <div class="w-full mb-3">
            <div v-for="task in customer.tasks" :key="task.id">
              <div class="grid grid-cols-12 gap-x-10 text-[14px] text-gray-700 font-light my-1.5" v-for="product in task.products" :key="product.id">
                <div class="col-span-5">{{ product.name }}, {{ moment(task.date).format('DD/MM/YYYY') }}</div>
...
import { PhFunnel, PhBuilding, PhUser, PhAlignLeftSimple, PhMapPin, PhCheck, PhX } from '@phosphor-icons/vue';
